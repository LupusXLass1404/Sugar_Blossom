        ...
        <div class="row contact-border my-5">
            ...
            <div class="col-lg-6 px-0 contact-card">
                <form id="loginForm" class="p-5 contact-form" method="post">
                    ...
                    <div>
                        <a href="index.php?do=register" style="color:#ffffff; text-decoration: underline;">Sign up.</a>
                    </div>

                    <div>
                        <a href="index.php?do=forget" style="color:#ffffff; text-decoration: underline; flow: right">Forgot password?</a>
                    </div>
